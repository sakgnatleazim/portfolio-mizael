...
export default function AdminPanel({ data, onSave, onReset, onLogout }) {
  ...
  // FileReader to convert file to Base64 string with client-side compression
  const handleImageFileChange = (e, callback) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        const img = new Image()
        img.onload = () => {
          // Kompresi gambar: Maksimal dimensi 1000px lebar/tinggi
          ...
          // Ekspor sebagai JPEG terkompresi (kualitas 0.7)
